                ...
                <ul className="controls">
                    <li className={'controls__item'}>
                        <NavLink className={'controls__link'} to={`${url}/favorites`}>
                            ...
                            {favorites.allFavorites.length ? <span className={'badge'}>{favorites.allFavorites.length}</span> : null}
                        </NavLink>
                    </li>
                    <li className={'controls__item'}>
                        <NavLink className={'controls__link'} to={`${url}/cart`}>
                            ...
                            {cart.cartItemCount ? <span className={'badge'}>{cart.cartItemCount}</span> : null}
                        </NavLink>
                    </li>
                    <li className="controls__item">
